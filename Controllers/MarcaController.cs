...
namespace thirdProject.Controllers
{
    public class MarcaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Descricao")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Descricao")] Marca marca)
        {
            if (id != marca.Id)
            {
                return NotFound();
